        ...
        children: [
          ...
          if (hasLider)
            _PendingItem(
              ...
              title: 'Avaliação de Colaboradores / Prestadores',
              subtitle: '$pendingLiderCount colaborador${pendingLiderCount > 1 ? 'es' : ''}/prestador${pendingLiderCount > 1 ? 'es' : ''} aguardando envio',
